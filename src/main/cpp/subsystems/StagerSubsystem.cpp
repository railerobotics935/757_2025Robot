...
StagerSubsystem::StagerSubsystem() : m_stagerMotor{StagerConstants::kMotorID, StagerConstants::kMotorType},
  ...
  rev::spark::SparkMaxConfig stageMotorConfig{};
  ...
  rev::spark::SparkMaxConfig stagerFollowerConfig{};

  stagerFollowerConfig 
  .SetIdleMode(rev::spark::SparkMaxConfig::IdleMode::kBrake)
  .VoltageCompensation(RobotConstants::kVoltageCompentationValue)
  .Follow(m_stagerMotor, true);
  ...
  m_stagerMotor.Configure(stageMotorConfig, rev::spark::SparkMax::ResetMode::kResetSafeParameters, rev::spark::SparkMax::PersistMode::kPersistParameters);
  m_stagerFollower.Configure(stagerFollowerConfig, rev::spark::SparkMax::ResetMode::kResetSafeParameters, rev::spark::SparkMax::PersistMode::kPersistParameters);
