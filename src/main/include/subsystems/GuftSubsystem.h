 ...
 */
 ...
 private:
  ...
  // Motor Controllers;
  rev::spark::SparkMax m_guftMotor;

  // Encoders motor controllers
  rev::spark::SparkAbsoluteEncoder m_guftAbsoluteEncoder = m_guftMotor.GetAbsoluteEncoder();

  // PID Contollers for
  rev::spark::SparkClosedLoopController m_guftPIDController = m_guftMotor.GetClosedLoopController();
};