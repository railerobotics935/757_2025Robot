 ...
 */
 ...
 private:
  ...
  // Motor Controllers
  rev::spark::SparkMax m_topShooterMotor;
  rev::spark::SparkMax m_bottomShooterMotor;
  rev::spark::SparkMax m_pitchMotor;

  // Encoders motor controllers
  rev::spark::SparkRelativeEncoder m_topShooterEncoder = m_topShooterMotor.GetEncoder();
  rev::spark::SparkRelativeEncoder m_bottomShooterEncoder = m_bottomShooterMotor.GetEncoder();
  rev::spark::SparkAbsoluteEncoder m_pitchAbsoluteEncoder = m_pitchMotor.GetAbsoluteEncoder();

  // PID Contollers for
  rev::spark::SparkClosedLoopController m_topShooterPIDController = m_topShooterMotor.GetClosedLoopController();
  rev::spark::SparkClosedLoopController m_bottomShooterPIDController = m_bottomShooterMotor.GetClosedLoopController();
  rev::spark::SparkClosedLoopController m_pitchPIDController = m_pitchMotor.GetClosedLoopController();
};